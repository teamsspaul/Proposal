...
\begin{frame}{Analytical Procedure - Burnup}
  \begin{align*}
    \begin{itemize}
    \item{Burnup depends on}
    \item{Calculated three ways}
    \end{itemize}
...
\begin{frame}{Analytical Procedure - Fluence Rate}
  \begin{itemize}
  \item{Flow to make Nd, maybe assumptions into Cs calculation}
  \item{Show Nd Cross section}
  \item{Assumptions before below calculation}
  \end{itemize}
  \begin{equation*}
...
\begin{frame}{Analytical Procedure - Fuel Age}
  \begin{itemize}
  \item{Depends on solving bateman, with previous assumptions on burnup, $\phi$,
    initial enrichment, fast to thermal ratios (calculate new 1000 x-sections)}
  \end{itemize}
  \begin{equation*}
