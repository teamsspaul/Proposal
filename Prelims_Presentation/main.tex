...
\begin{frame}{Chemical Context}
  %% background
  \tikz[overlay, remember picture]\node[xshift=-1.7cm, yshift=6.5cm, opacity=1]at (current page.south east){\includegraphics[width=3cm]{figures/TBP2}};
  \begin{itemize}
...
\begin{frame}{Analytical Procedure - Initial Enrichment and Fuel Age}
