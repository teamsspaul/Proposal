...
\begin{frame}{Nuclear and Reprocessing Context}
  %\vspace{-1cm}
  \begin{itemize}
  ...
  \item{CANDU Reactor}
    \begin{figure}[H]
      \begin{flushright}
        \includegraphics[scale = 0.24]{figures/BurnPuComp_grams}
      \end{flushright}
    \end{figure}
  \item{Decontaminated plutonium may be used to give indication of material origins\tss{\cite{}}}
  \end{itemize}
