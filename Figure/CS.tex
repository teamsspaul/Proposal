...
%% 
  \node[name=Cs137, Element]
       {\NaturalElementTextFormat
         {\\$\bm{(n,\gamma)\ss{}{55}{138}Cs}$\\}
         %{\\~\\Stable - 5.8\%}
         {\\$\bm{\beta^{-1}\rightarrow\ss{}{56}{147}Ba}$}
         %{\\$\bm{\ss{}{60}{148}}$Nd}
         {$\bm{\ss{}{55}{137}}$Cs}
         {0.025 eV: 0.2\\Epi: 0.3}
         {}
       };
  \node[name=Xe136, below of=Cs137, Element]
       {\NaturalElementTextFormat
         ...
         {\\$\bm{(n,\gamma)\ss{}{54}{137}Xe}$\\}
         {\\Stable 8.9\%}
         {$\bm{\ss{}{54}{136}}$Xe}
         %{2.45 MeV: 0,0,0\\14.1 MeV: 0.4,0.06,0.04}
         {0.025 eV: 0.2\\Epi: 0.1}
         {}
       };
   \node[name=Xe137, right of=Xe136, Element]
        {\NaturalElementTextFormat
          {}
          {\\$\bm{\beta^{-1}\rightarrow\ss{}{55}{137}Cs}$}
          {$\bm{\ss{}{54}{137}}$Xe}
          {}
          {3.8 min}
        };
  \node[name=Cs136, left of=Cs137, Element]
       {\NaturalElementTextFormat
         {\\$\bm{(n,\gamma)\ss{}{55}{137}Cs}$}
         %{\\~\\Stable - 5.8\%}
         {\\$\bm{\beta^{-1}\rightarrow\ss{}{56}{136}Ba}$}
         %{\\$\bm{\ss{}{60}{148}}$Nd}
         {$\bm{\ss{}{55}{136}}$Cs}
         {0.025 eV: 11\\Epi: 57}
         {13 days}
