...
\begin{tikzpicture}[node distance=1.5cm,
  ...
  \node (Fast)      [process, below of=burnup]      {Loop over Fast-to-Thermal Ratios and Determine};
  ...
  %                                  (onCreateBlock);
  \draw[->] (unity.east) -- ++(2,0) -- ++(0,5) -- ++(0,2) -- ++ (-1,0) --              
     node[xshift=1.15cm,yshift=-2.7cm, text width=2cm]
